  ...
  return (
    ...
    `} ref={footerRef}>
        <div className='flex flex-col gap-5 sm:justify-center sm:items-center'>
            ...
            <div className='text-[18px] text-black font-bold flex flex-col sm:flex-row sm:gap-1'>
                <span>Ozhur, Tirur, Malappuram</span>
                <span>Ozhur P.O, 676307</span>
            </div>
            <div className='text-[18px] text-black font-bold flex flex-col sm:flex-row sm:gap-3'>
